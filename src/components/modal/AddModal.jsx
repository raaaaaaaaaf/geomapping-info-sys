            ...
            <Grid container spacing={2} key={index}>
              ...
              <Grid item xs={2}>
                <TextField
                  ...
                  value={record.name}
                  onChange={(e) =>
                    handleOccupantsInputChange(e, index, "name")
                  }
                />
              </Grid>
              <Grid item xs={3}>
              ...
              <Grid item xs={1.5}>
                <TextField
                  ...
                  onChange={(e) => handleOccupantsInputChange(e, index, "cstatus")}
                />
              </Grid>
              <Grid item xs={3}>
                <TextField
                  ...
                  label="Occupation of the Company"
                  variant="outlined"
                  fullWidth
                  value={record.occupation}
                  onChange={(e) => handleOccupantsInputChange(e, index, "occupation")}
                />
              </Grid>
            </Grid>
          ))}
